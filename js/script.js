...
const imageBeginnerList = [
	{	card: 1,
		img: "https://i.postimg.cc/8CqgdGsx/perrito-1.jpg"
	},
	{	card: 2,
		img: "https://i.postimg.cc/9MjNFQDX/perrito-2.jpg"
	},
	{	card: 3,
		img: "https://i.postimg.cc/J4gxzzgw/perrito-3.jpg"
	},
	{	card:4,
	img: "https://i.postimg.cc/4yc6Kzqr/perrito-4.jpg"
	},
	{	card: 5,
		img: "https://i.postimg.cc/yYVx3mMc/perrito-5.jpg"
	},
	{	card: 6,
		img: "https://i.postimg.cc/MZtx4hLf/perrito-6.jpg"
	},
	{	card: 7,
...
function resetScore() {
	...
	document.querySelector('.paragraph_moves').innerText = 'Movimientos: 0';
	clickCounter = 0;
}
		...
		imagesTop[i].addEventListener('click', function (evt) {
			if (imagesTop[i].className === 'image_top') {
				...
				if (selectedImages.length === 2) {
					...
					document.querySelector('.paragraph_moves').innerText = 'Movimientos: ' + clickCounter;
					document.querySelector('.final_moves').innerText = 'Movimientos: ' + clickCounter;
				}
				checkGameOver();
			}
		});
